...
async def send_msg(bot, filename, caption): 
    try:
        ...
        if resized_poster:
            await bot.send_photo(chat_id=DEENDAYAL_MOVIE_UPDATE_CHANNEL, photo=resized_poster, caption=caption_message, reply_markup=InlineKeyboardMarkup(btn))
        else:      
            await bot.send_message(chat_id=DEENDAYAL_MOVIE_UPDATE_CHANNEL, text=caption_message, reply_markup=InlineKeyboardMarkup(btn))
