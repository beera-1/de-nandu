...
auth_channel = environ.get('AUTH_CHANNEL', '-1003297155836 -1002164939634')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002370539446').split()]
