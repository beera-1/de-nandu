...
API_ID = int(environ.get('API_ID', '20822386'))
API_HASH = environ.get('API_HASH', '4f0069e749e20d9c399447b4a34f5a45')
...
PICS = (environ.get('PICS', 'https://envs.sh/G55.jpg https://envs.sh/Gzy.jpg https://envs.sh/GzV.jpg https://envs.sh/Gz-.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/bnN.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = environ.get('SUBSCRIPTION', 'https://graph.org/file/242b7f1b52743938d81f1.jpg')
FSUB_PICS = (environ.get('FSUB_PICS', 'https://graph.org/file/7478ff3eac37f4329c3d8.jpg https://envs.sh/bnN.jpg')).split()

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin
          for admin in environ.get('ADMINS', '6390511215').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch
            for ch in environ.get('CHANNELS', '-1001881877723 -1002370539446 -1002366465096').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001956199528'))
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1001956199528'))
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002511011441'))
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001956199528'))
auth_channel = environ.get('AUTH_CHANNEL', '-1003297155836')
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch
                   for dch in environ.get('DELETE_CHANNELS', '-1002474691060').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002304364794')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003353030088')
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch
                for fch in environ.get('AUTH_CHANNEL', '-1003297155836').split()]
MULTI_FSUB = [int(channel_id) for channel_id in
              environ.get('MULTI_FSUB', '-1003108825356 -1002164939634').split()
              if re.match(r'^-?d+$', channel_id)]

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/bnD.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 's.s.115@superyes')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://movie1:movie1@cluster0.pgyfk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://movie2:movie2@cluster0.jicer.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "movie")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Nandu_files')
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002370988072'))
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/How_To_Open_the_Link_01')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_the_Link_01')
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+ryOl6LexqbpkZjM0')
OWNERID = int(os.environ.get('OWNERID', '6390511215'))
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+yNuVpdAI7jUzMmY1')
P_TTI_SHOW_OFF = is_enabled(environ.get('P_TTI_SHOW_OFF', "False"), False)
IMDB = is_enabled(environ.get('IMDB', "False"), False)
AUTO_FFILTER = is_enabled(environ.get('AUTO_FFILTER', "True"), True)
AUTO_DELETE = is_enabled(environ.get('AUTO_DELETE', "True"), True)
DELETE_TIME = int(environ.get("DELETE_TIME", "300"))  # from second block
